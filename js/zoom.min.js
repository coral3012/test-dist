(function(e) {
    ...
    function a() {
        var t = i.parent(".gallery_item").prev();
        if (t.length == 0) t = e(".gallery .gallery_item:last-child");
        t.find("a").trigger("click")
    }
    function f() {
        var t = i.parent(".gallery_item").next();
        if (t.length == 0) t = e(".gallery .gallery_item:first-child");
    ...
    (function() {
        ...
        if (e(".gallery .gallery_item a").length == 1) e(".gallery .gallery_item a")[0].addClass("zoom");
        e(".zoom, .gallery .gallery_item a").on("click", u)
    })();
    (function() {
